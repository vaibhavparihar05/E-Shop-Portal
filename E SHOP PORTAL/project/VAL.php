                ...
                <?php
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        while($row = mysqli_fetch_array($result))
                        {
                            ...
                            if($row[3]=='mobile'){
                                $path="mobiledesc.php?x=$row[0]";
                            }
                            else{
                                $path="tvdesc.php?x=$row[0]";
                            }
                            echo "<td class='ab'><a  href = '$path'>Add Desc</a></td>";
                            echo "<td class='ab'><a  href = 'deleteproduct.php?pid=$row[0]&ptype=$row[3]'>Delete</a></td>";
                            echo "</tr>";
